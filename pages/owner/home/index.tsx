    ...
    datasets: [
      {
        label: "# Votes",
        data: [20, 100, 500],
        backgroundColor: ["#44C2FD", "#FAEE81", "#5F59F7"],
        borderColor: ["#44C2FD", "#FAEE81", "#5F59F7"],
        borderWidth: 1,
      },
    ],
  };
            ...
            <div className="w-full flex gap-2 items-center justify-between">
              <div className="flex items-center gap-4">
                <img
                  ...
                  alt="logo"
                  className="w-18 h-18 object-cover object-center bg-white p-1 rounded-full"
                />
                <div>
